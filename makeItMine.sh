...
mysoft=("kitty" "vim" "ubuntu-gnome-desktop" "gdm3" "okular" "gnome-tweaks" "python3" "python3-pip" "python3-venv" "cmake" "net-tools" "curl" "xclip" "wine" "gimp" "wireshark" "ffmpeg" "vlc" "qemu-kvm libvirt-daemon-system libvirt-clients bridge-utils" "virt-manager" "gnome-shell-extensions" "npm" "golang" "apt-transport-https")
...
(sudo crontab -l; echo '* 12 * * * apt upgrade -y') | sudo crontab -
